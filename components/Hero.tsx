  ...
  return (
    <section className="relative flex flex-col items-center w-full bg-[#0A0A0A] py-16 px-6 md:py-[100px] md:px-[120px] overflow-hidden">
      ...
      <h1 className="font-grotesk text-[clamp(32px,10vw,96px)] font-bold text-[#F5F5F0] tracking-[-1px] leading-none text-center w-full max-w-[1100px]">
        <GlitchText text={profile.heroHeadlineLines[0]} speed={45} delay={100} />
        <br />
        <GlitchText text={profile.heroHeadlineLines[1]} speed={45} delay={400} />
      </h1>
      <h1 className="font-grotesk text-[clamp(32px,10vw,96px)] font-bold text-[#FFD600] tracking-[-1px] leading-none text-center w-full max-w-[1100px]">
        <GlitchText text={profile.heroHeadlineAccent} speed={45} delay={700} />
      </h1>
      ...
      <p className="font-ibm-mono text-[13px] md:text-[15px] text-[#888888] tracking-[1px] leading-[1.6] text-center w-full max-w-[800px]">
        {profile.heroSubtitleLines[0]}
        <br />
        {profile.heroSubtitleLines[1]}
      </p>
...
const files: TreeRow[] = [
  { label: "app/", color: "#FFD600", indent: 0, active: true },
  { label: "page.tsx", color: "#60A5FA", indent: 12 },
  { label: "layout.tsx", color: "#888", indent: 12 },
  { label: "components/", color: "#4ADE80", indent: 0 },
  { label: "Hero.tsx", color: "#60A5FA", indent: 12 },
  { label: "Showcase.tsx", color: "#888", indent: 12 },
  { label: "lib/", color: "#FF6B35", indent: 0 },
  { label: "api.ts", color: "#888", indent: 12 },
  { label: "package.json", color: "#888", indent: 0 },
];
...
const fileMeta: MetaRow[] = [
  { key: "LINES", val: "412" },
  { key: "SIZE", val: "11.4kB" },
  { key: "TYPES", val: "strict" },
  { key: "COVER", val: "94%" },
  { key: "STACK", val: "next", swatch: "#60A5FA" },
  { key: "LANG", val: "ts", swatch: "#FFD600" },
  { key: "CI", val: "passing", swatch: "#4ADE80" },
  { key: "DEPLOY", val: "auto" },
];

const commits = [
  { name: "feat: hero", hex: "#4ADE80" },
  { name: "fix: api", hex: "#FF6B35" },
  { name: "test: ci", hex: "#60A5FA" },
  { name: "docs: readme", hex: "#888888" },
  { name: "chore: deps", hex: "#FFD600" },
];
...
function WorkspaceSVG({ mounted }: { mounted: boolean }) {
  return (
    <>
      ...
      >
        ...
        <text x="12" y="23" fontFamily="monospace" fontSize="9" fill="#FFD600" letterSpacing={2} fontWeight="700">FILES</text>
        ...
        <text x="912" y="23" fontFamily="monospace" fontSize="9" fill="#FFD600" letterSpacing={2} fontWeight="700">FILE</text>
        ...
        {/* Separator + Commit log title */}
        <line x1="899" y1="278" x2="1100" y2="278" stroke="#222" strokeWidth="1" />
        <text x="912" y="300" fontFamily="monospace" fontSize="9" fill="#FFD600" letterSpacing={2} fontWeight="700">COMMITS</text>
        ...
        <text x="280" y="84" fontFamily="monospace" fontSize="8" fill="#FFD600" letterSpacing={1}>preview — localhost:3000</text>
        ...
        <text x="325" y="252" fontFamily="monospace" fontSize="7" fill="#0A0A0A" fontWeight="700" letterSpacing={0.5}>VIEW WORK</text>
        <rect x="418" y="236" width="90" height="24" fill="none" stroke="#3D3D3D" strokeWidth="1.5" />
        <text x="430" y="252" fontFamily="monospace" fontSize="7" fill="#555" letterSpacing={0.5}>GET IN TOUCH</text>
        ...
        <text x="360" y="293" fontFamily="monospace" fontSize="7" fill="#333" letterSpacing={1}>deploy.ts — production</text>
        ...
        <text x="330" y="568" fontFamily="monospace" fontSize="8" fill="#333" letterSpacing={1}>9 FILES</text>
        <text x="430" y="568" fontFamily="monospace" fontSize="8" fill="#333" letterSpacing={1}>TS: STRICT</text>
        <text x="600" y="568" fontFamily="monospace" fontSize="8" fill="#333" letterSpacing={1}>BRANCH: MAIN</text>
        <text x="770" y="568" fontFamily="monospace" fontSize="8" fill="#333" letterSpacing={1}>v1.0.0</text>
