...
/** Section the primary navbar CTA jumps to. */
const CTA_SECTION = "projects";
    ...
    >
      <div className="flex items-center justify-between h-[60px] px-6 md:px-[48px] max-w-[1400px] mx-auto">
        ...
        <div className="hidden md:flex items-center gap-[14px]">
          ...
          <button
            onClick={() => scrollTo(CTA_SECTION)}
            className="font-grotesk text-[11px] font-bold text-[#0A0A0A] bg-[#FFD600] tracking-[1.5px] px-[18px] py-[9px] hover:bg-[#F5F5F0] transition-colors cursor-pointer"
          >
            VIEW WORK
          </button>
        </div>
      ...
      >
        <nav className="flex flex-col px-6 py-5 gap-0">
          ...
          <div className="flex flex-col gap-[10px] pt-5">
            ...
            <button
              onClick={() => { scrollTo(CTA_SECTION); setMenuOpen(false); }}
              className="font-grotesk text-[11px] font-bold text-[#0A0A0A] bg-[#FFD600] tracking-[1.5px] px-[18px] py-[11px] text-center hover:bg-[#F5F5F0] transition-colors cursor-pointer"
            >
              VIEW WORK
            </button>
          </div>
